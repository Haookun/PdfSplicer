...
PdfSplicer est là pour vous ! Cet outil intelligent pour macOS propose une interface moderne CustomTkinter avec prise en charge du glisser-déposer, reconnaît automatiquement l'ordre des pages et fusionne en un PDF complet.

## Fonctionnalités
- Interface moderne CustomTkinter, épurée et élégante
- Glisser-déposer ou cliquer pour sélectionner les fichiers PDF
...
- Saut automatique des pages blanches : option activable, utilise l'analyse du ratio de pixels blancs pour détecter et ignorer intelligemment les pages vides (y compris les pages quasi blanches du scanner) pour une fusion plus efficace.
